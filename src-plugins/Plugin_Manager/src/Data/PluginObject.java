...
public class PluginObject {
	...
	private ArrayList dependency = null; //2-element arrays of ==> 0: filename, 1: timestamp
	...
	public PluginObject(String strFilename, String md5Sum, String timestamp, String directory, String description, ArrayList dependency, boolean loaded, boolean toInstall) {
		this.strFilename = strFilename;
		this.md5Sum = md5Sum;
		this.timestamp = timestamp;
		this.directory = directory;
	...
	public void setDependency(ArrayList dependency) {
		this.dependency = dependency;
	}
	...
	public String[] getDependency(int index) {
		return (String[])dependency.get(index);
	}
