...
class UpdateUI extends JPanel {
	...
	private UpdateTableModel pluginModel = null;
	private JTable table = null;
	private JTextPane txtPluginDetails = null;

	public UpdateUI(PluginManager pluginManager) {
		super();
		this.setLayout(null);
		this.pluginManager = pluginManager;

		/* Create the plugin table */
		table = new JTable(pluginModel = new UpdateTableModel());
		        ...
		        new ListSelectionListener() {
		            public void valueChanged(ListSelectionEvent event) {
		                ...
		                if (viewRow < 0) {
		                    ...
		                    PluginObject myPlugin = (PluginObject)updatesPluginList.get(modelRow);
	...
	//Update button to check for any updates, retrieve that information
	private void retrieveUpdateInfo() {
		pluginManager.clickToGenerateUpdates();
	}

	//Download button to begin process of downloading
	private void showDownloadManager() {
		pluginManager.clickToDownloadUpdates();
	}
	...
	public void setUpdatesPluginList(List<PluginObject> arr) {
		updatesPluginList = arr;
		pluginModel.update(updatesPluginList);
	}
}
...
class UpdateTableModel extends AbstractTableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		{
			case 0:
				return new Boolean(entry.getToInstallStatus());
			case 1:
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		...
		if(columnIndex == 0)
		{
			entry.setToInstall(((Boolean)value).booleanValue());
