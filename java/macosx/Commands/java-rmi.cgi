...
#
# Mac OS X note:
# This runs the "current" version of Java. If you want to use 
# a particular version of the JDK, specify the absolute path of that 
# version's Commands directory. For example, to explicitly use 1.3.1: 
# PATH=/System/Library/Frameworks/JavaVM.framework/Versions/1.3.1/Commands:$PATH
#
